    ...
    return (
        <div className="flex w-full justify-center">
            <div className="relative w-full max-w-3xl">
                <Input
                    value={input}
                    className="h-10 min-h-10 rounded-full py-2 pr-12 pl-4 shadow-sm disabled:cursor-not-allowed disabled:opacity-60"
                    placeholder={isGenerating ? "Generating response..." : "Message ScalerbookLM..."}
